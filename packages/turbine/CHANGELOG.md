...
- [`69e390e`](https://github.com/metalizzsas/NusterKit/commit/69e390e42c868d947c8f70dc6f51df892d60c408) Thanks [@Kworz](https://github.com/Kworz)! - fix(pbr): run conditions that were sometimes reactive, sometimes not
...
- [`678740e`](https://github.com/metalizzsas/NusterKit/commit/678740e4d5969ce84317f3afb90d20d0d85d6f56) Thanks [@Kworz](https://github.com/Kworz)! - fix(io): a hung Modbus request no longer freezes the WAGO — and a finished cycle stops its timers
...
- [`d053aa1`](https://github.com/metalizzsas/NusterKit/commit/d053aa1ce4a511953a7ca8399a87450acd452176) Thanks [@Kworz](https://github.com/Kworz)! - fix(profiles): seed premade profiles in one transaction instead of eighty-four
...
- [#592](https://github.com/metalizzsas/NusterKit/pull/592) [`e93c36a`](https://github.com/metalizzsas/NusterKit/commit/e93c36a5b9756ce2395adaa737a107fa08adde59) Thanks [@github-actions](https://github.com/apps/github-actions)! - fix(boot): stop a slow database at startup from crash-looping the machine
...
- [`32ec6c1`](https://github.com/metalizzsas/NusterKit/commit/32ec6c18e55ef585dbdd54ca81b5bbc87f9f8929) Thanks [@Kworz](https://github.com/Kworz)! - fix(containers): read the container table in one query instead of one per container
...
- [`4afd012`](https://github.com/metalizzsas/NusterKit/commit/4afd012f8e2c61ae2dc9c3f0b7389c9847495a6d) Thanks [@Kworz](https://github.com/Kworz)! - fix(docker): run the process as root again, so NetworkManager answers
...
- [`6e60588`](https://github.com/metalizzsas/NusterKit/commit/6e605889e1a44a2b6d97a6988870179940d27d42) Thanks [@Kworz](https://github.com/Kworz)! - fix(docker): stop the container restart loop caused by corepack
...
- feat: IOWrite gate will retry to after 1 s ([#372](https://github.com/metalizzsas/NusterKit/pull/372))
