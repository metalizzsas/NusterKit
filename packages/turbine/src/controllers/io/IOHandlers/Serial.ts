...
import type { ISerialController } from "@metalizzsas/nuster-typings/build/spec/iophysicalcontrollers/SerialController";

import { LoggerInstance } from "../../../app";
import { SerialPort } from "serialport";

export class Serial implements IIOPhysicalController, ISerialController
{
