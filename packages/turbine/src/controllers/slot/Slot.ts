import { ICallToAction } from "@metalizzsas/nuster-typings/build/spec/nuster/ICallToAction";
import { ISlotHydrated, ISlotProductData } from "@metalizzsas/nuster-typings/build/hydrated/slot";
