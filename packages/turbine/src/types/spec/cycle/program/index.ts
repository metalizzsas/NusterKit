...
export type StartTimerProgramBlock = {
	start_timer: {
...
export type SetRegulationStateProgramBlock = {
	set_regulation_state: { container: StringParameterBlocks; regulation: StringParameterBlocks; state: NumericParameterBlocks };
};
