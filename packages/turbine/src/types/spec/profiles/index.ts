...
type ProfileSkeletonFields = (
	| IProfileSkeletonFieldFloat
	| IProfileSkeletonFieldBoolean
	| IProfileSkeletonFieldNumber
	| IProfileSkeletonFieldTime
	| IProfileSkeletonFieldIncremental
) &
	IProfileSkeletonField;
...
export type { Profile, ProfileSkeleton, ProfileSkeletonFields };
