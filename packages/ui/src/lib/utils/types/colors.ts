...
type pseudo = "hover:" | "dark:" | "dark:hover:";
...
type single<ctx extends context, Pseudo extends boolean> = nested<ctx, Pseudo> | root<ctx, Pseudo>;

export type TailwindColors<ctx extends context, Pseudo extends boolean> = single<ctx, Pseudo> | `${single<ctx, Pseudo>} ${single<ctx, boolean>}`;