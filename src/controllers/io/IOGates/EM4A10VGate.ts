...
export class EM4A10VIOGate extends IOGate
{
    ...
    public async read(ioController: IOController)
    {
        ...
        ioController.machine.logger.trace("EM4A10V:" + this.name + ": Reading data from fieldbus.");
    ...
    public async write(ioController: IOController, data: number)
    {
        ...
        ioController.machine.logger.trace("EM4A10V-" + this.name + ": Writing (" + v + ") to fieldbus.");
